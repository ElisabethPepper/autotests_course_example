...
# Выходные данные:
# кортеж типа tuple из двух элементов:
# результат вычисления кинетической энергии и словарь с информацией о вызовах функции
# Пример:
#
...
# get_kinetic_energy(5, 2) --> (10.0, {(5, 2): 10.0, (5, 3): 22.5})
...
def memorize(function):
    ...
    def wrapper(weight, speed):
        res = (weight, speed)
        if res not in cash.keys():
            func_res = function(weight, speed)
            cash.setdefault(res, func_res)
...
print(get_kinetic_energy(5, 2))  # --> (10.0, {(5, 2): 10.0})
print(get_kinetic_energy(5, 3))  # --> (22.5, {(5, 2): 10.0, (5, 3): 22.5})
print(get_kinetic_energy(5, 2))  # --> (22.5, {(5, 2): 10.0, (5, 3): 22.5})
